        ...
        <div class="profile-body">
          ...
          <form action="{{ route('admin.profil.update') }}" method="POST" id="profilForm">
            ...
            <div class="form-grid">
              ...
              <div class="form-group">
                <label>Email</label>
                <input type="text" name="email" class="input-readonly editable-field" value="{{ (Auth::guard('admin')->check() ? Auth::guard('admin')->user() : Auth::guard('warga')->user())->email }}" readonly>
              </div>

              <div class="form-group form-col-full">
                <label>Tanggal Bergabung</label>
                <input type="text" class="input-readonly" value="{{ (Auth::guard('admin')->check() ? Auth::guard('admin')->user() : Auth::guard('warga')->user())->created_at->translatedFormat('d F Y') }}" readonly>
              </div>
            </div>
