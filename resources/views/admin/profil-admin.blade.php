...
<head>
  ...
  <title>Profil Admin – SIPELAS</title>
...
<div class="page-body">
  ...
  <div class="content-area">
    <main class="content">
      ...
      <h2 class="page-title">Profil Admin</h2>      <!-- HEADER CARD -->
      ...
      <div class="section-card">
        <div style="padding: 24px 24px 20px; border-bottom: 1px solid var(--gray-200); display: flex; justify-content: space-between; align-items: center;">
            <h3 class="section-card-title" style="border: none; padding: 0;">Informasi Akun</h3>
            <button type="button" id="editNameBtn" title="Ubah Biodata" style="background: var(--blue-light); border: none; cursor: pointer; color: var(--blue); display: flex; align-items: center; justify-content: center; width: 32px; height: 32px; border-radius: 8px; transition: opacity .2s;">
        ...
        <div class="profile-body">
          ...
          <div class="info-box-blue">
            Data ini digunakan sebagai identitas resmi pada surat yang diterbitkan.<br>
            Pastikan nama dan jabatan sesuai.
          </div>

          <form action="{{ route('admin.profil.update') }}" method="POST" id="profilForm">
            @csrf
            <div class="form-grid">
              <div class="form-group form-col-full">
                <label>Nama Lengkap</label>
                <input type="text" id="nameInput" name="name" class="input-readonly editable-field" value="{{ Auth::user()->name ?? '' }}" readonly>
              </div>

              <div class="form-group">
                <label>Jabatan</label>
                <input type="text" name="jabatan" class="input-readonly editable-field" value="{{ Auth::user()->jabatan ?? 'Operator' }}" readonly>
              </div>

              <div class="form-group">
                <label>Email</label>
                <input type="text" name="email" class="input-readonly editable-field" value="{{ Auth::user()->email }}" readonly>
              </div>

              <div class="form-group form-col-full">
                <label>Tanggal Bergabung</label>
                <input type="text" class="input-readonly" value="{{ Auth::user()->created_at->translatedFormat('d F Y') }}" readonly>
              </div>
            </div>
            
            <div id="submitBtnContainer" style="margin-top: 24px; text-align: right; display: none;">
              <button type="button" id="cancelBtn" class="btn-cancel" style="margin-right: 12px;">Batal</button>
