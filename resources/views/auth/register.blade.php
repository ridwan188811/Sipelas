...
<head>
  ...
  <title>Daftar – SIPELAS</title>
  <meta name="description" content="Pendaftaran akun SIPELAS – Sistem Informasi Pelayanan Masyarakat Kelurahan Sambongpari" />
  
  <!-- Favicon & Open Graph (Logo untuk Link/Share WhatsApp) -->
  <link rel="icon" type="image/png" href="{{ asset('images/logo_tasikmalaya.png') }}">
  <meta property="og:title" content="Daftar SIPELAS - Kelurahan Sambongpari">
  <meta property="og:description" content="Daftar akun Sistem Informasi Pelayanan Masyarakat Kelurahan Sambongpari.">
        ...
        <div class="form-group">
          ...
          <div class="input-wrap">
            <input
              ...
              class="form-input has-icon @error('password_confirm') is-invalid @enderror"
              placeholder="Ulangi Kata Sandi Anda"
              required
              autocomplete="new-password"
            />
            <button type="button" class="eye-btn" aria-label="Tampilkan konfirmasi kata sandi" data-target="password_confirm">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
                <circle cx="12" cy="12" r="3"/>
              </svg>
